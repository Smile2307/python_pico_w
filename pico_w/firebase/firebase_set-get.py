# vido: https://www.youtube.com/watch?v=emu1KlFalKI
from firebase_tools import connect,reconnect,setdb_to_firebase,set_value,get_value
import time
...
'''
setdb_to_firebase(host="https://pico-test-89fc9-default-rtdb.firebaseio.com/",auth="dbXPGtg5uyGEts2X4RQspsF2aYhlLo11Zq8mPOkd",tree="random")
set_value(key="data",value=28.54)
